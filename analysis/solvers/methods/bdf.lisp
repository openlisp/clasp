...
(defmethod solver-bdf-0 ((m matrice-system) (vtrans class-variables) i h epsilon max-iter)
    (print "bdf0 - 0")
  (let* (
...
(defmethod solver-bdf-1 ((m matrice-system) (vtrans class-variables) i h epsilon max-iter)
   (print "bdf 1 0")
  (let* (
...
(defmethod solver-bdf-2 ((m matrice-system) (vtrans class-variables) i h epsilon max-iter)
  (print "bdf 2 0")
  (let* (
